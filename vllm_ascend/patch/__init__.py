...
#    Why:
#       vLLM 0.23.0 drops non-shape Dynamo guards after the first trace, so a
...
#    How:
#       For vLLM 0.23.0 only, extend the existing wrapper before model loading
...
#    Related PR (if no, explain why):
#       No. This is a release-specific compatibility patch while the generic
