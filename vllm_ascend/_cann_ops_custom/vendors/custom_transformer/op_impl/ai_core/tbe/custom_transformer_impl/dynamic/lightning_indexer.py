...
def _build_args(query_in__, key_in__, weights_in__, actual_seq_lengths_query_in__, actual_seq_lengths_key_in__, block_table_in__, sparse_indices_out_, sparse_values_out_, layout_query, layout_key, sparse_count, sparse_mode, pre_tokens, next_tokens, return_values):
    __inputs__ = []
...
@para_check.check_op_params(para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.REQUIRED_OUTPUT, para_check.REQUIRED_OUTPUT, para_check.OPTION_ATTR_STR, para_check.OPTION_ATTR_STR, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_BOOL, para_check.KERNEL_NAME)
def lightning_indexer(query_in__, key_in__, weights_in__, actual_seq_lengths_query_in__=None, actual_seq_lengths_key_in__=None, block_table_in__=None, sparse_indices_out_=None, sparse_values_out_=None, layout_query="BSND", layout_key="BSND", sparse_count=2048, sparse_mode=3, pre_tokens=9223372036854775807, next_tokens=9223372036854775807, return_values=False, kernel_name="lightning_indexer", impl_mode = ""):
    # do ascendc build step
    if get_current_build_config("enable_op_prebuild"):
        return
    __inputs__, __outputs__, __attrs__ = _build_args(query_in__, key_in__, weights_in__, actual_seq_lengths_query_in__, actual_seq_lengths_key_in__, block_table_in__, sparse_indices_out_, sparse_values_out_, layout_query, layout_key, sparse_count, sparse_mode, pre_tokens, next_tokens, return_values)
    ...
    op_info = OpInfo(kernel_name = kernel_name, op_type = op_type, inputs = __inputs__, outputs = __outputs__,\
        attrs = __attrs__ , impl_mode = impl_mode, origin_inputs=[query_in__, key_in__, weights_in__, actual_seq_lengths_query_in__, actual_seq_lengths_key_in__, block_table_in__], origin_outputs = [sparse_indices_out_, sparse_values_out_],\
                param_type_dynamic = False, mc2_ctx = [], param_type_list = ['required', 'required', 'required', 'optional', 'optional', 'optional', 'required', 'required'], init_value_list = [None, None],\
                output_shape_depend_on_compute = [])
    compile_op(src, origin_func_name, op_info, options, code_channel, '{}', {'valueDepend': {}})

def op_select_format(query_in__, key_in__, weights_in__, actual_seq_lengths_query_in__=None, actual_seq_lengths_key_in__=None, block_table_in__=None, sparse_indices_out_=None, sparse_values_out_=None, layout_query="BSND", layout_key="BSND", sparse_count=2048, sparse_mode=3, pre_tokens=9223372036854775807, next_tokens=9223372036854775807, return_values=False, impl_mode = ""):
    __inputs__, __outputs__, __attrs__ = _build_args(query_in__, key_in__, weights_in__, actual_seq_lengths_query_in__, actual_seq_lengths_key_in__, block_table_in__, sparse_indices_out_, sparse_values_out_, layout_query, layout_key, sparse_count, sparse_mode, pre_tokens, next_tokens, return_values)
    result = check_op_cap("op_select_format", "LightningIndexer", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")

def get_op_specific_info(query_in__, key_in__, weights_in__, actual_seq_lengths_query_in__=None, actual_seq_lengths_key_in__=None, block_table_in__=None, sparse_indices_out_=None, sparse_values_out_=None, layout_query="BSND", layout_key="BSND", sparse_count=2048, sparse_mode=3, pre_tokens=9223372036854775807, next_tokens=9223372036854775807, return_values=False, impl_mode = ""):
    __inputs__, __outputs__, __attrs__ = _build_args(query_in__, key_in__, weights_in__, actual_seq_lengths_query_in__, actual_seq_lengths_key_in__, block_table_in__, sparse_indices_out_, sparse_values_out_, layout_query, layout_key, sparse_count, sparse_mode, pre_tokens, next_tokens, return_values)
