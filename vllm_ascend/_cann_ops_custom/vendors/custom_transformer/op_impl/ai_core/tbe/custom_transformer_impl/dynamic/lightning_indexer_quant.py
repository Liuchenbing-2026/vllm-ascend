...
def get_dtype_fmt_options(__inputs__, __outputs__):
    options = []
    input_names = ['query', 'key', 'weights', 'query_dequant_scale', 'key_dequant_scale', 'actual_seq_lengths_query', 'actual_seq_lengths_key', 'block_table']
...
def _build_args(query_in__, key_in__, weights_in__, query_dequant_scale_in__, key_dequant_scale_in__, actual_seq_lengths_query_in__, actual_seq_lengths_key_in__, block_table_in__, sparse_indices_out_, query_quant_mode, key_quant_mode, layout_query, layout_key, sparse_count, sparse_mode):
    __inputs__ = []
    for arg in [query_in__, key_in__, weights_in__, query_dequant_scale_in__, key_dequant_scale_in__, actual_seq_lengths_query_in__, actual_seq_lengths_key_in__, block_table_in__]:
        if arg != None:
...
@tbe_register.register_operator("LightningIndexerQuant", trans_bool_to_s8=False)
@para_check.check_op_params(para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.REQUIRED_OUTPUT, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_STR, para_check.OPTION_ATTR_STR, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_INT, para_check.KERNEL_NAME)
def lightning_indexer_quant(query_in__, key_in__, weights_in__, query_dequant_scale_in__, key_dequant_scale_in__, actual_seq_lengths_query_in__=None, actual_seq_lengths_key_in__=None, block_table_in__=None, sparse_indices_out_=None, query_quant_mode=0, key_quant_mode=0, layout_query="BSND", layout_key="PA_BSND", sparse_count=2048, sparse_mode=3, kernel_name="lightning_indexer_quant", impl_mode = ""):
    # do ascendc build step
    if get_current_build_config("enable_op_prebuild"):
        return
    __inputs__, __outputs__, __attrs__ = _build_args(query_in__, key_in__, weights_in__, query_dequant_scale_in__, key_dequant_scale_in__, actual_seq_lengths_query_in__, actual_seq_lengths_key_in__, block_table_in__, sparse_indices_out_, query_quant_mode, key_quant_mode, layout_query, layout_key, sparse_count, sparse_mode)
    ...
    origin_func_name = "lightning_indexer_quant"
    ascendc_src_dir_ex = "lightning_indexer_quant"
    ascendc_src_dir = "lightning_indexer_quant"
    ascendc_src_file = "lightning_indexer_quant.cpp"
    src = get_kernel_source(ascendc_src_file, ascendc_src_dir, ascendc_src_dir_ex)

    msg = "start compile Ascend C Operator LightningIndexerQuant, kernel name is " + kernel_name
    CommonUtility.print_compile_log("", msg, AscendCLogLevel.LOG_INFO)
    op_type = "LightningIndexerQuant"
    ...
    op_info = OpInfo(kernel_name = kernel_name, op_type = op_type, inputs = __inputs__, outputs = __outputs__,\
        attrs = __attrs__ , impl_mode = impl_mode, origin_inputs=[query_in__, key_in__, weights_in__, query_dequant_scale_in__, key_dequant_scale_in__, actual_seq_lengths_query_in__, actual_seq_lengths_key_in__, block_table_in__], origin_outputs = [sparse_indices_out_],\
                param_type_dynamic = False, mc2_ctx = [], param_type_list = ['required', 'required', 'required', 'required', 'required', 'optional', 'optional', 'optional', 'required'], init_value_list = [None],\
                output_shape_depend_on_compute = [])
    compile_op(src, origin_func_name, op_info, options, code_channel, '{}', {'valueDepend': {}})

def op_select_format(query_in__, key_in__, weights_in__, query_dequant_scale_in__, key_dequant_scale_in__, actual_seq_lengths_query_in__=None, actual_seq_lengths_key_in__=None, block_table_in__=None, sparse_indices_out_=None, query_quant_mode=0, key_quant_mode=0, layout_query="BSND", layout_key="PA_BSND", sparse_count=2048, sparse_mode=3, impl_mode = ""):
    __inputs__, __outputs__, __attrs__ = _build_args(query_in__, key_in__, weights_in__, query_dequant_scale_in__, key_dequant_scale_in__, actual_seq_lengths_query_in__, actual_seq_lengths_key_in__, block_table_in__, sparse_indices_out_, query_quant_mode, key_quant_mode, layout_query, layout_key, sparse_count, sparse_mode)
    result = check_op_cap("op_select_format", "LightningIndexerQuant", __inputs__, __outputs__, __attrs__)
...
def get_op_specific_info(query_in__, key_in__, weights_in__, query_dequant_scale_in__, key_dequant_scale_in__, actual_seq_lengths_query_in__=None, actual_seq_lengths_key_in__=None, block_table_in__=None, sparse_indices_out_=None, query_quant_mode=0, key_quant_mode=0, layout_query="BSND", layout_key="PA_BSND", sparse_count=2048, sparse_mode=3, impl_mode = ""):
    __inputs__, __outputs__, __attrs__ = _build_args(query_in__, key_in__, weights_in__, query_dequant_scale_in__, key_dequant_scale_in__, actual_seq_lengths_query_in__, actual_seq_lengths_key_in__, block_table_in__, sparse_indices_out_, query_quant_mode, key_quant_mode, layout_query, layout_key, sparse_count, sparse_mode)
    result = check_op_cap("get_op_specific_info", "LightningIndexerQuant", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")
