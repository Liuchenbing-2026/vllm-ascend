...
class NPUModelRunner(GPUModelRunner):
    ...
    def _sync_metadata_across_dp(
        ...
        self._all_dp_ranks_have_tokens = bool((actual_num_tokens_across_dp > 0).all().item())
    ...
    def execute_model(
        ...
        with record_function_or_nullcontext("prepare input"):
            with self.synchronize_input_prep():
                ...
                if not num_scheduled_tokens:
                    self._run_empty_dp_dummy_forward()
                ...
                (
                    ...
                    actual_num_tokens=num_tokens_unpadded,
                )
        ...
        with (
            ...
            set_ascend_forward_context(
                ...
                or (
                    _is_a2_megamoe_enabled()
                    and not self._a2_megamoe_decode_graph_safe
                ),
    ...
    def _dummy_run(
        ...
        with self.maybe_dummy_run_with_lora(
            ...
            with set_ascend_forward_context(
                ...
                batch_descriptor=batch_desc,
                model_instance=self.model,
                skip_compiled=is_profile and _is_a2_megamoe_enabled(),
                has_sinks = self._has_sinks,
                input_ids=input_ids,
                eplb_heat_collection_status=self.eplb_heat_collection_status if self.dynamic_eplb else False,
                moe_comm_type_override=moe_comm_type_override,
