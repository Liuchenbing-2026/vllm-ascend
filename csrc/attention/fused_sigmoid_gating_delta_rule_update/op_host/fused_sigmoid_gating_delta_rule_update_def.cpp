...
/*!
 * \file fused_sigmoid_gating_delta_rule_update.h.cpp
 * \brief
 */
#include "register/op_def_registry.h"

namespace ops {
class FusedSigmoidGatingDeltaRuleUpdate : public OpDef {
public:
    explicit FusedSigmoidGatingDeltaRuleUpdate(const char *name) : OpDef(name)
    {
        this->Input("A_log")
            .ParamType(REQUIRED)
...
OP_ADD(FusedSigmoidGatingDeltaRuleUpdate);
