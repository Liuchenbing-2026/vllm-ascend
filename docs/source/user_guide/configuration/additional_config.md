...
| `mega_moe_min_tokens`               | int  | `512`   | Minimum batch token count for selecting CANN MegaMoe on supported Atlas A2 W8A8 expert-parallel deployments. Valid range: 1 to 4096. Smaller batches retain the standard MC2 or all-gather path. |
