...
| `force_a2_moe_allgather`            | bool | `False` | Force A2 MoE communication to use ALLGATHER instead of automatic MC2 selection. Use only as a compatibility fallback for A2 multi-node topologies where MC2 cannot make forward progress. |
